...
def powerSpectrumSlope(nu, z, slope_type = 'P', scale = 1.0, 
	...
	n_eff = powerSpectrumSlopeFromM(M_L, z, slope_type = slope_type, scale = scale, 
...
def powerSpectrumSlopeFromM(M_L, z, slope_type = 'P', scale = 1.0, 
					ps_args = defaults.PS_ARGS, sigma_args = defaults.SIGMA_ARGS):
	"""
	The slope of the linear matter power spectrum for halos of a given Lagrangian mass.
	
	See :func:`powerSpectrumSlope` for details.
