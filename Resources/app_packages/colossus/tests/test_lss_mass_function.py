...
class TCMassFunction(test_colossus.ColosssusTestCase):
	...
	def test_hmfModelsSO_200m(self):
		...
		for k in models.keys():
			...
			if k == 'tinker08':
				...
				correct = [2.614018367770e-01, 4.379054088157e-05]
			else:
				msg = 'Unknown model, %s.' % k
				raise Exception(msg)
	...
	def test_hmfModelsSO_vir(self):
		...
		for k in models.keys():
			...
			if k == 'tinker08':
			...
			elif k == 'rodriguezpuebla16':
				correct = [2.232142653534e-01, 4.571038965730e-05]
			elif k == 'comparat17':
				...
				correct = [3.329859566522e-01, 7.519923859269e-05]
			elif k == 'fernandezgarcia26':
				correct = [2.510060929181e-01, 7.090532154245e-05]
			elif k == 'fiorilli26':
				correct = [2.575357881486e-01, 4.293543971322e-05]
			else:
				msg = 'Unknown model, %s.' % k
				raise Exception(msg)
